...
public class CustomTable extends JTable {
    /*
     * This custom table is a Jtable that accepts an array of arrays and column
     * header
     * Colors itself with its private cell renderer with a palette (mixed style) of
     * two types of colors
     * It Colors the odd rows with color1 and even rows with color2
     * Colors it header with accepted color
     * And this render works to change the color of JTable header with desired color
     * in color1 variable
    ...
    public class TableListener implements ListSelectionListener {
        /*
         * This table listener creates and shows an individual custom page based on the
         * row touched in and table id
         */
