...
public class OfficialsPanelOld extends JPanel implements ParentPanel{
    ...
    public OfficialsPanelOld(BasePanel displayPanel){
        ...
        addTab(edit,new OfficialsPanel(displayPanel));
